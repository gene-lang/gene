...
- [interception.md](interception.md) — Beta explicit runtime interception reference for class methods, standalone callables, keyword/spread preservation, diagnostics, and removed AOP-era APIs
