...
- **Scenario 2**: When encountering a semantic error during compilation, parsing should stop and the compile error should be reported with context information
...
Gene SHALL provide error messages that distinguish between parse errors and compile errors, providing appropriate context information.

#### Scenarios:
- **Scenario 1**: Parse errors should clearly indicate the problematic syntax
- **Scenario 2**: Compile errors should include the compilation context
- **Scenario 3**: Error messages should clearly indicate whether it's a parse error or compile error
...
- **Scenario 2**: The function should preserve error context information
...
#### Scenarios:
- **Scenario 1**: ParseError exceptions should include appropriate context
