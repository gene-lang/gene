...
- Require function-type metadata to preserve parameter kind, keyword labels, variadic position, keyword-rest value type, and the distinction between omitted and explicit return types.
