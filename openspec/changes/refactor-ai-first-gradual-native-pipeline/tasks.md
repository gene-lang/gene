...
- [ ] 0.2 Fix the symbol-index regression before descriptor-pipeline rollout.
...
- [ ] 1.2 Remove string-first type transport from compiler metadata (`type_expectations`) and switch to descriptor references.
- [ ] 1.3 Persist descriptor tables in GIR with stable IDs and module-path provenance.
...
- [ ] 3.1 Add targeted tests for mixed typed/untyped modules and descriptor serialization parity.
- [ ] 3.2 Add GIR cache invalidation tests (old cache rejected/recompiled, new cache accepted).
