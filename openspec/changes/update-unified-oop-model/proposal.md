...
- Affected code: `src/gene/types.nim`, `src/gene/compiler.nim`, `src/gene/vm.nim`, `src/gene/vm/core.nim`, selector/navigation handling, testsuite, `docs/proposals/future/oop_updated_design.md`
