...
- [x] 1.3 Add descriptor interning helpers for compiler/runtime use.
...
- [x] 3.1 Emit descriptor IDs alongside existing string metadata during compilation.
- [x] 3.2 Teach runtime validation to prefer descriptor/runtime objects.
- [x] 3.3 Preserve string fallback paths during migration.

## 4. Validation
- [x] 4.1 Add mixed typed/untyped boundary tests using descriptor paths.
- [x] 4.2 Add import/module boundary tests validating descriptor continuity.
